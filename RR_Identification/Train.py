...
def statistics(data_state, tag2idx):
    ...
    cm_df = pd.DataFrame(cm,
                         index = ['PREAMBLE','NONE','FAC','ISSUE','ARG_PETITIONER','RLC','ANALYSIS','PRE_RELIED','RATIO','RPC','STA','ARG_RESPONDENT','PRE_NOT_RELIED'], 
                         columns = ['PREAMBLE','NONE','FAC','ISSUE','ARG_PETITIONER','RLC','ANALYSIS','PRE_RELIED','RATIO','RPC','STA','ARG_RESPONDENT','PRE_NOT_RELIED'])
