...
if __name__ == "__main__":
  ...
  query_triplets = read_knowledge_graph(query_csv_file_path)
  ...
  document_triplets = read_knowledge_graph(document_csv_file_path)

  # Print the triplets for the query
  print("Query Triplets:")
  for triplet in query_triplets:
    print(triplet)

  # Print the triplets for the document
  print("\nDocument Triplets:")
  for triplet in document_triplets:
    print(triplet)
